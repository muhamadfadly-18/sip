...
class Auto_number {
	...
	public function generate_id_PR()
	{
		//Kondisi bila id sudah di set
		if(isset($this->id))
		{
	...
	public function generate_id_WS()
	{
		//Kondisi bila id sudah di set
		if(isset($this->id))
		{
	...
	public function generate_id_FG()
	{
		//Kondisi bila id sudah di set
		if(isset($this->id))
		{
	...
	public function generate_id_bk()
	{
		//Kondisi bila id sudah di set
		if(isset($this->id))
		{
