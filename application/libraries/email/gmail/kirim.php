...
require_once "library/SMTP.php";
	...
	$mail->Username = "smartsystem@asinusa.com";   //nama-email smtp          
	$mail->Password = "orhqaifyjoknznjt";           //password email smtp
	//If SMTP requires TLS encryption then set it
	$mail->SMTPSecure = "tls";                           
	//Set TCP port to connect to 
	$mail->Port = 587;                                   
 
	$mail->From = "smartsystem@asinusa.com"; //email pengirim
