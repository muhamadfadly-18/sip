...
class PHPExcel_Style_Fill extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	const FILL_PATTERN_DARKDOWN				= 'bg-defaultDown';
	const FILL_PATTERN_DARKGRAY				= 'bg-defaultGray';
	const FILL_PATTERN_DARKGRID				= 'bg-defaultGrid';
	const FILL_PATTERN_DARKHORIZONTAL		= 'bg-defaultHorizontal';
	const FILL_PATTERN_DARKTRELLIS			= 'bg-defaultTrellis';
	const FILL_PATTERN_DARKUP				= 'bg-defaultUp';
	const FILL_PATTERN_DARKVERTICAL			= 'bg-defaultVertical';
