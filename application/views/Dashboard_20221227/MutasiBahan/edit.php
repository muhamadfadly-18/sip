<div class="page-content padding-30 container-fluid">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('MutasiBahan');?>">Mutasi Produksi</a></li>
        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              ...
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>MutasiBahan/update/<?= $data->id_mutasi_bahan?>" method="post">
