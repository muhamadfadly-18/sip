            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>Barang/add_action" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name='tujuan_input' id="tujuan_input" class="form-control">
                      <option value="0">Pilih Tujuan </option>
                      <option value="1">Barang </option>
                      <option value="2">Barang Produksi</option>
                      <option value="3">Barang Finish Good</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" autocomplete="off" placeholder="HS Code/Kode Barang" required name="kode_barang" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Uraian Barang : </label>
                  <div class="col-sm-5">
                    <input type="text" autocomplete="off" placeholder="Uraian Barang" required name="nama_barangg" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name='satuan' id="satuan" class="form-control">
                      ...
                      foreach ($satuan as $value) {   ?>
                        <option value="<?= $value->uom ?>"><?= $value->uom  ?> - <?= $value->keterangan  ?></option>
                      <?php }
                      ?>
                  ...
                  <div class="col-sm-4">
                    <select name='lokasi' id="terminal" class="form-control">
                      ...
                      foreach ($terminal as $value) {   ?>
                        <option value="<?= $value->terminal ?>"><?= $value->terminal  ?></option>
                      <?php }
                      ?>
