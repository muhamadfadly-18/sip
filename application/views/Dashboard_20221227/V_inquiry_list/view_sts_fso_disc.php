    ...
    <div class="panel-body">
      <div class="col-sm-12 col-md-12">
        ...
        <form class="form-horizontal" action="#" method="post">
          ...
          <?php if ($DataInquiry->vessel_activity == 1 || $DataInquiry->vessel_activity == 2) { ?>

            <div class="form-group">
              <label class="col-sm-2 control-label" style="text-align: left;">Cargo MT</label>
              <div class="col-sm-10">
                <label class="control-labe" style="width: 20px; font-weight: bold;">:</label>
                <label class="control-labe" style="font-weight: bold;"><?php echo $DataInquiry->cargo_mt; ?></label>
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-2 control-label" style="text-align: left;">Cargo Type</label>
              <div class="col-sm-10">
                <label class="control-labe" style="width: 20px; font-weight: bold;">:</label>
                <label class="control-labe" style="font-weight: bold;"><?php echo $v_cargo_type; ?></label>
              </div>
            </div>
          ...
          <?php }elseif($vessel_activity == 3 || $vessel_activity == 4 || $vessel_activity == 5){ ?>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" style="text-align: left;">MFP/Oil Bunker MT</label>
              <div class="col-sm-10">
                <label class="control-labe" style="width: 20px; font-weight: bold;">:</label>
                <label class="control-labe" style="font-weight: bold;"><?php echo $DataInquiry->mfp; ?></label>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <label class="control-labe" style="width: 20px; font-weight: bold;">:</label>
              <label class="control-labe" style="font-weight: bold;">USD $<?php echo $DataInquiry->total_sts_feeder_FSO; ?></label>
            </div>
          </div>
