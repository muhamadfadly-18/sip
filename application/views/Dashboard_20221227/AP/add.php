...
<div class="page-header">
  ...
  <div class="page-header-actions">
    <a href="<?php echo base_url('AP');?>" class="btn btn-sm btn-danger  btn-round">
      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-6">
          ...
          <div class="example-wrap">
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url();?>AP/add_action" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="PO Date" required name="po_date" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">Tanggal AP : </label>
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" placeholder="Tanggal AP" required name="tanggal_ap" class="form-control">
                  </div>
                </div>
