        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              <h4 class="example-title">Edit Data Jenis Dokumen</h4>
              <p>
                **Isi kolom di bawah dengan benar.
              </p>
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>Jenis_dokumen/update/<?= $data->id_dokumen ?>" method="post">

                <div class="form-group">
                    <label class="col-sm-2 control-label">UOM : </label>
                    <div class="col-sm-5">
                      <input type="text" autocomplete="off"  required name="txt1" class="form-control" value="<?= $data->dokumen ?>">
                    </div>
                </div>
                <div class="form-group">
