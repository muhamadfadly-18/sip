...
<script type="text/javascript">
  ...
  function addPK() {
    ...
    cell3.innerHTML = '<input type="text" class="form-control classQty" style="width:100%;" class="form-control" >';
    ...
    $(".selectX").select2({
      ...
      for(var i=0;  i<=table.rows.length; i++) {
        ...
        hitung = document.getElementsByClassName("classQty")[i].id = "qty"+i;
        console.log(hitung);
