                  ...
                  ?>
                    <tr>
                      <td>
                        ...
                        <td>
                          <select class="form-control selectX classKeteranganBarang" id="KeteranganBarang" onchange="validasi()" style="width:100%;">
                        ...
                        <td><input type="text" class="form-control classQty" style="width:100%;" class="form-control" id="qty_edit" value="<?= $value->jumlah ?>"></td>
                        <!-- <td><input type="text" autocomplete="off"  name="" class="form-control" value="<?= $value->jumlah ?>"></td> -->
                        <td><input type="text" class="form-control classSat" style="width:100%;" class="form-control" id="sat" value="<?= $value->id_satuan ?>" readonly></td>
                        ...
                        <td>
                          <select id="tank" class="form-control selectX classTank" style="width:100%;" onchange="validasi()">
                            <option>Pilih</option>
                            <?php
                        ...
                        <td>
                          <select class="form-control selectX classCur" style="width:100%;">'+
                            <option value="">Pilih</option>
                            <?php
                        ...
                        <td><input type="text" class="form-control classHarga" style="width:100%;" class="form-control" id="harga_edit" value="<?= $value->harga ?>"></td>
                        <!-- <td><input type="text" autocomplete="off"  name="" class="form-control" value="<?= $value->nilai_barang ?>"></td> -->
                        <td><input type="text" class="form-control classTotal" style="width:100%;" value="<?= $value->nilai_barang ?>" class="form-control" id="total_edit"></td>
...
<script type="text/javascript">
  ...
  function addPK() {
    ...
    cell4.innerHTML = '<input type="text" class="form-control classSat" style="width:100%;" class="form-control" id="sat" readonly>';
