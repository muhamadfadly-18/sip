              ...
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>Ws/add_action" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" autocomplete="off" placeholder="No BC" required name="no_bc" class="form-control">
                    </div>                  
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="date" autocomplete="off" placeholder="Tanggal BC" required name="tanggal_bc" class="form-control">
                    </div>                  
                  </div>
