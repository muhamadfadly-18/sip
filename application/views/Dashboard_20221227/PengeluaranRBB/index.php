							...
							<td>
								<div class="btn-group" role="group"> 
									...
									<li role="presentation">
										<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('PengeluaranRBB/edit/'.$value->id_bk);?>">
										<i class="icon wb-edit" aria-hidden="true"></i>
										Edit
										</a>
									</li>
									<li role="presentation">
										<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('PengeluaranRBB/delete/'.$value->id_bk);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
