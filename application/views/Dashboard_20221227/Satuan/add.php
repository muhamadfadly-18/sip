        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              <h4 class="example-title">Tambah Data Satuan</h4>
              <p>
                **Isi kolom di bawah dengan benar.
              </p>
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>Satuan/add_action" method="post">

                <div class="form-group">
                    <label class="col-sm-2 control-label">UOM : </label>
                    <div class="col-sm-5">
                      <input type="text" autocomplete="off" placeholder="UOM" required name="txt1" class="form-control">
                    </div>
                </div>
                <div class="form-group">
