...
<div class="page-content padding-30 container-fluid">
	...
	<div class="page-header">
	  <h1 class="page-title" style="text-transform: capitalize;">Data Satuan</h1>
	  <ol class="breadcrumb">
	    <li><a href="<?php echo base_url();?>">Beranda</a></li>
	    <li class="active">Satuan</li>
	  </ol>
	  <div class="page-header-actions">
		  <a href="<?php echo base_url('Satuan/add/');?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
				            	...
				            	<div class="btn-group" role="group">
				                    ...
				                    <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
				                      <li role="presentation">
				                      	<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Satuan/edit/'.$value->id_unit);?>">
				                      	<i class="icon wb-edit" aria-hidden="true"></i>
				                      	Edit
				                      	</a>
				                      </li>
				                      <li role="presentation">
				                      	<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Satuan/delete/'.$value->id_unit);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
