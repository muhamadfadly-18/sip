        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              <h4 class="example-title">Edit Data Jurnal Umum Baru</h4>
              <p>
                **Isi kolom di bawah dengan benar.
              </p>
               <div class="form-group">
                <form id ="form-jurnal-umum" class="form-horizontal" action="<?php echo base_url();?>JurnalUmum/save/edit" method="post">
				  <div class="form-group">
                    <label class="col-sm-2 control-label">No Jurnal : </label>
                    <div class="col-sm-2">

                      <input type="hidden" name="id_group">
                      <input type="text" autocomplete="off" placeholder="" required name="no_jurnal" class="form-control" value="<?=$jurnal_umum[0]['no_jurnal']?>" readonly="readonly">
                    </div>  
					<label class="col-sm-2 control-label">Tanggal Jurnal : </label>
                    <div class="col-sm-3">
                      <input type="hidden" name="id_group">
                      <input type="date" autocomplete="off" placeholder="" required name="tgl_jurnal" class="form-control" value="<?=$jurnal_umum[0]['tgl_jurnal']?>">
                    </div>       					
                  </div>
	              <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <input type="hidden" name="id_group">
                      <input type="text" autocomplete="off" placeholder="" required name="no_bukti" class="form-control" value="<?=$jurnal_umum[0]['no_bukti']?>">
                    </div>                  
                  </div>
				  <div class="form-group">
                    <label class="col-sm-2 control-label">Keterangan : </label>
                    <div class="col-sm-5">
                    <textarea cols="30" rows="3"  class="form-control" name="ket"><?=$jurnal_umum[0]['ket']?></textarea>
                    </div>                   
                  </div>
				  <div class="form-group">
...
<script type="text/javascript">
  _jsonju = <?=json_encode($jurnal_umum)?>;
  function myFunction() {
      var sub1 = $("#no_rek").val();
      $.ajax({
