<div class="page-content padding-30 container-fluid">
	...
	<div class="page-header">
		<h1 class="page-title" style="text-transform: capitalize;">Neraca Saldo</h1>
		<ol class="breadcrumb">
	...
	<div class="panel panel-bordered panel-primary">
	    ...
	    <div class="example">
			<form id="IdForm" class="form-horizontal" method="post" action="<?php echo base_url();?>LapNS">
