        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              ...
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>PemasukanRBB/add_action" method="post">
...
<script type="text/javascript">
  ...
  function addPK() {
    ...
    // cell3.innerHTML = '<input type="text" class="form-control classNama" style="width:100%;" class="form-control" id="nama" readonly>';
     cell2.innerHTML = '<select class="form-control selectX classCur" style="width:100%;">'+
                      ...
                      <?php } ?>
                      '</select>';
    cell3.innerHTML = '<select class="form-control selectX classKeteranganBarang" id="KeteranganBarang" onchange="validasi()" style="width:100%;">'+
                      '<option value="">Pilih</option>'+
                      <?php 
    ...
    cell6.innerHTML = '<select id="terminal" class="form-control selectX classTerminal" style="width:100%;">'+
                      '<option value="">Pilih</option>'+
                      <?php 
                      ...
                      <?php } ?>
                      '</select>';
    cell7.innerHTML = '<select id="tank" class="form-control selectX classTank" style="width:100%;">'+
                      '<option value="">Pilih</option>'+
