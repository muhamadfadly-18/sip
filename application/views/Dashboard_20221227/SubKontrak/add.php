        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              <h4 class="example-title">Tambah Data Sub Kontrak Baru</h4>
              <p>
                **Isi kolom di bawah dengan benar.
              </p>
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>SubKontrak/add_action" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <input type="hidden" name="id_group">
                      <input type="date" autocomplete="off" placeholder="Tanggal Subkontrak" required name="tanggal_subkontrak" class="form-control">
                    </div>                   
                  </div>
                  <div class="form-group">
