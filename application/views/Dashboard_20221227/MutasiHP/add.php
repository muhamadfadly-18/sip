<div class="page-content padding-30 container-fluid">
  ...
  <div class="page-header">
    <h1 class="page-title">Mutasi Hasil Produksi</h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>">Beranda</a></li>
      <li><a href="<?php echo base_url('MutasiHP');?>">Mutasi Hasil Produksi</a></li>
        ...
        <div class="row row-lg">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="example-wrap">
              <h4 class="example-title">Tambah Data Mutasi Hasil Produksi</h4>
              <p>
                **Isi kolom di bawah dengan benar.
              </p>
              <div class="example">
                <form class="form-horizontal" action="<?php echo base_url();?>MutasiHP/add_action" method="post">
