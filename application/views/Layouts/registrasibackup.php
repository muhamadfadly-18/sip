...
<body class="page-login layout-full page-dark">
      ...
      <div class="panel"  style="width: 100%;">
        <div class="panel-body">
          <div class="brand">
            ...
            <h1 style="font-size: 20px; text-align: left;">Estimation Asinusa Port Cost Calculator (Port Tariff & Port Dues to Government/PNBP)</h1>
          </div>
          <br>
          ...
          <form method="post" id="IdFormLogin">
            ...
            <div class="form-group form-material floating">
              ...
              <input type="text" class="form-control" name="gross_register" id="rupiah" onkeypress="return isNumber(event)"/>
              <label class="floating-label" style="color: black; font-size: 13px;">Gross Register Tonnase (GRT)</label>
            </div>

            <div class="form-group form-material floating">
              <span class="spansss">(NTR)</span>
              <input type="text" class="form-control" name="net_register" id="rupiah1" onkeypress="return isNumber(event)"/>
              <label class="floating-label" style="color: red; font-size: 13px;">*Net Register Tonnase (NRT)</label>
            </div>

            <div class="form-group form-material floating">
              <span class="spansss">(DWT)</span>
              <input type="text" class="form-control" name="dead_weight" id="rupiah2" onkeypress="return isNumber(event)"/>
              <label class="floating-label" style="color: red; font-size: 13px;">*Dead Weight Tonnase (DWT)</label>
            </div>

            <div class="form-group form-material floating">
              <span class="spansss">Meter</span>
              <input type="text" class="form-control" name="lenght_over" id="rupiah3" onkeypress="return isNumber(event)"/>
            ...
            <div class="form-material floating">
              <div class="col-sm-6">
                <select name="vessel_activity" class="form-control" required id="id_vessel_activity" onchange="ShowHide()">
                  <option>--- Select ---</option>
                  <option value="1">STS Regular</option>
                  <option value="2">STS FSO/FSU(FT)</option>
                  <option value="3">WO</option>
                  <option value="4">Bungker</option>
                  <option value="5">Oil Barge/Ex-Wharf</option>
                  <!-- <?php
              ...
              <div class="col-sm-6">
                <select id="id_va_detail" name="va_detail" class="form-control" required>
                  <option>--- Select ---</option>
                </select>
              </div>
            </div>
           ...
           <br>
            ...
            <div class="form-group form-material floating" id="CargoMT">
              ...
              <input type="text" class="form-control" name="cargo_mt" onkeypress="return isNumber(event)"/>
            ...
            <div class="form-group form-material floating" id="MFP">
              <input type="text" class="form-control" name="mfp" id="rupiah3" onkeypress="return isNumber(event)"/>
  ...
  function ShowHide(){
    var id_vessel_activity = $("#id_vessel_activity").val();

    if (id_vessel_activity == "1" || id_vessel_activity == "2") {
    ...
    }else if(id_vessel_activity == "4" || id_vessel_activity == "5") {
