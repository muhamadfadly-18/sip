...
$qry_pilotage = $this->db->query("SELECT * from ref_tarif_pilotage where   nilai_akhir >= '$gross_register' order by id_tarif_pilotage ASC limit 1 ")->row();
  $result_pilotage = ($qry_pilotage->tarif*2);
$qry_isps = $this->db->query("SELECT * from ref_tarif_isps_wo where  nilai_akhir >= $gross_register and type = 'wo/bunkering' order by id_tarif_isps_wo ASC limit 1 ")->row();
  $result_isps = $qry_isps->rate;


$tgl1 = strtotime($arrival);
$tgl2 = strtotime($departure);
$days = $tgl2 - $tgl1;
$jarak = floor($days / (60 * 60 * 24)+1) ;

// $tgl1 = new DateTime($arrival);
// $tgl2 = new DateTime($departure);
// $days = $tgl2->diff($tgl1);
// $jarak = (($days->d)+1);
...
$qry_anchorage = $this->db->query("SELECT * from ref_tarif_shiptoship_services order by id_tarif_shiptoship_services DESC limit 1 ")->row();
  $result_anchorage = $qry_anchorage->rate;
  $result_wo = ($result_anchorage * $jarak)* $gross_register;
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" id="IdFormLogin">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" placeholder="Gross Register Ton (GTR)" name="gross_register" value="<?php echo $gross_register; ?>" class="form-control" readonly>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" placeholder="Net Register Tonnage (NTR)" name="net_register" value="<?php echo $net_register; ?>" class="form-control" readonly>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" placeholder="Dead Weight Tonnage (DWT)" name="dead_weight" value="<?php echo $dead_weight; ?>" class="form-control" readonly>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off" placeholder="Lenght Over All (LOA)" name="lenght_over" value="<?php echo $lenght_over; ?>" class="form-control" readonly>
              </div>
            </div>
            ...
            <?php if ($vessel_activity == 1 || $vessel_activity == 2) { ?>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" autocomplete="off" placeholder="Cargo MT" name="mfp" value="<?php echo $mfp; ?>" class="form-control" readonly>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label" style="color: black; font-size: 15px;">Cargo Type : </label>
                <div class="col-sm-9">
                  <select name="cargo_type" class="form-control" readonly>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off"  name="" value="<?php echo $jarak; ?> Days" class="form-control" readonly>
              </div>
            </div>
...
<!--
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" style="color: black; font-size: 15px;">WO : </label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off"  name="" value="<?php echo $result_wo; ?>" class="form-control" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label" style="color: black; font-size: 15px;">Cargo Transfer : </label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off"  name="" value="<?php echo $result_cargo_transfer1; ?>" class="form-control" readonly>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" style="color: black; font-size: 15px;">Cargo Transfer : </label>
              <div class="col-sm-9">
                <input type="text" autocomplete="off"  name="" value="<?php echo round($result_cargo_transfer) ?>" class="form-control" readonly>
              </div>
            </div> -->

            <?php  $total =  ($result_pilotage + $result_isps + $result_wo + $result_cargo_transfer1 + $result_osr + round($result_labuh) + round($result_rambu) + round($result_vts)+ round($result_pup)+ round($result_cargo_transfer)) ?> </h1>

            <h1>Total Port Cost : USD <?php echo  rupiah($total); ?>
            <hr>
            <div class="form-group">
