...
<body class="page-login layout-full page-dark">
  ...
  <div class="page animsition vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle" style="padding-right: 20%;">
      <div class="panel"  style="width: 175%;">
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" id="IdFormLogin">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" autocomplete="off"  name="" value="<?php echo round($result_sts); ?>" class="form-control" readonly>
              </div>
            </div>
            <div class="form-group">
            ...
            <h1>Total Port Cost : USD <?php echo  rupiah($total_barge_oil); ?>
            <hr>
            <!-- <div class="form-group">
              <div class="col-sm-4 col-sm-offset-8">
                <a href="<?php echo base_url('Registrasi');?>" class="btn btn-sm btn-danger  btn-round">
