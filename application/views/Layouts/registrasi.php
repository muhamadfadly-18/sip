...
<body class="page-login layout-full page-dark">
        ...
        <div class="panel-body">
          ...
          <form method="post" id="IdFormLogin">
            ...
            <div class="form-material floating">
              <label class="floating-label" style="font-weight: bold; color: black; font-size: 15px;">Isi Data Diri</label>
              &nbsp;
            </div>

            <div class="form-group form-material floating">
              <input type="text" class="form-control" name="nama" value="" />
              <label class="floating-label" style="color: black; font-size: 13px; padding-bottom: 10%;">Name</label>
            </div>

            <div class="form-group form-material floating">
              <input type="email" class="form-control" name="email" value="" />
              <label class="floating-label" style="color: black; font-size: 13px; padding-bottom: 10%;">Email</label>
            </div>

            <div class="form-group form-material floating">
              <div class="col-sm-6">
                <div class="form-group form-material floating">
                  <select name="kode_telepon" class="form-control" required>
                    <?php
                      $KodeTelpon = $this->db->query("SELECT * FROM ref_kode_telepon ORDER BY NamaNegara ASC")->result();
                      foreach($KodeTelpon as $value){
                    ?>
                      <option value="<?php echo $value->KodeTelepon; ?>"><?php echo $value->NamaNegara; ?> (<?php echo $value->KodeTelepon; ?>)</option>
                    <?php
                      }
                    ?>
                  </select>
                  <label class="floating-label" style="color: black; font-size: 13px;">Country Code</label>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group form-material floating">
                  <input type="text" class="form-control" name="no_wa" value="" maxlength="13" onkeypress="return isNumber(event)" />
                  <label class="floating-label" style="color: black; font-size: 13px;">Whatapp Number (without country code)</label>
                </div>
              </div>
            </div>
            <br>
            ...
            <div class="form-material floating">
              <label class="floating-label" style="font-weight: bold; color: black; font-size: 15px;">Vessel</label>
              &nbsp;
            </div>

            <div class="form-group form-material floating">
              <input type="text" class="form-control" name="vessel_name" value="" />
            ...
            <div class="form-group form-material floating">
              ...
              <label class="floating-label" style="color: black; font-size: 13px;">Company Name (Shipping Company/Ship Charterer/Cargo Owner/Agent)</label>
            </div>
           ...
           <br>
            ...
            <div class="form-group form-material floating" id="CargoMT">
              ...
              <input type="text" class="form-control" name="cargo_mt" id="rupiah4"  onkeypress="return isNumber(event)"/>
            ...
            <div class="form-group form-material floating" id="MFP">
              <input type="text" class="form-control" name="mfp" id="rupiah5"/>
            ...
            <div class="form-material floating">
              <div class="col-sm-6">
                <div class="form-group form-material floating">
                  <input type="date" class="form-control" name="arrival_date" id="id_tbb"/>
            ...
            <div class="form-material floating">
              <div class="col-sm-6">
                <div class="form-group form-material floating">
                  <input type="date" class="form-control" name="departure_date" id="id_tbb1"/>
                  <label class="floating-label" style="color: black; font-size: 13px;">Date</label>
                </div>
              </div>
              <div class="col-sm-6">
  ...
  <script>
    ...
    $(function(){
      ...
      $('#id_tbb').attr('min', maxDate);
      $('#id_tbb1').attr('min', maxDate);
    });
