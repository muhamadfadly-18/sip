...
<div class="page-content padding-30 container-fluid">
  ...
  <div class="page-header">
    <h1 class="page-title" style="text-transform: capitalize;">Laporan Data Pemasukan Barang</h1>
    <ol class="breadcrumb">
...
<script type="text/javascript">
  function subFilter() {
    document.getElementById("IdForm").action = "<?php echo base_url(); ?>BML";
  ...
  function subExcel() {
    document.getElementById("IdForm").action = "<?php echo base_url(); ?>BML/export_excel";
    document.getElementById("IdForm").submit();
