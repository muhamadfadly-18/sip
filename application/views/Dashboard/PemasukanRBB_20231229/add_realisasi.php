            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>PemasukanRBB/add_action_realisasi" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="date" autocomplete="off" placeholder="" name="penerimaan_kargo_tgl" class="form-control"  value="<?= $data_estimasi->penerimaan_kargo_tgl ?>">
                  </div>
                  <div class="col-sm-2">
                    <input type="time" name="penerimaan_kargo_time" class="form-control" placeholder="" value="<?= $data_estimasi->penerimaan_kargo_time ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <tbody id="myTablePK" >
                    <?php
                      ...
                      foreach ($data_estimasi_result as $value_result) :
                        $countconvertion = $value_result->nilai_barang * $value_result->biaya_kurs;
                        ?>
                  <tr>
                      
                      <!-- <td><input type="text" autocomplete="off" name="" class="form-control" readonly="readonly" value="<?= $dataGet->id_barang ?>"></td> -->
                      <td><input type="text" readonly="readonly" onkeyup="myFunctionKeyup(<?= $no ?>)" autocomplete="off" id="qty_real_showE<?= $no ?>" name="qty_real_showE<?= $no ?>" class="form-control" value="<?= number_format($value_result->jumlah, 0, ".", ""); ?>" ></td>
                      <td>
                      ...
                      <td><input type="text" id="harga_satuan_real_showE<?= $no ?>" name="harga_satuan_real<?= $no ?>" class="form-control" onkeyup="myFunctionKeyup(<?= $no ?>)" value="<?= number_format($value_result->harga, 0, ".", ""); ?>" readonly="readonly"></td>
                      <td><input type="text" autocomplete="off" id="hasil_real_show<?= $no ?>" value="<?= number_format($value_result->nilai_barang, 2, ",", "."); ?>" name="hasil_real_show<?= $no ?>" class="form-control" readonly="readonly" ><input type="text" autocomplete="off" id="hasil_real_showE<?= $no ?>" name="hasil_real<?= $no ?>" value="<?= $value_result->nilai_barang ?>" class="form-control" style="display: none;" value="" ></td>
                      <td><input type="text" id="harga_satuan_real_showE<?= $no ?>" name="harga_satuan_real<?= $no ?>" class="form-control" onkeyup="myFunctionKeyup(<?= $no ?>)" value="<?= number_format($value_result->biaya_kurs, 2, ",", "."); ?>" readonly="readonly"></td>
                      <td><input type="text" class="form-control classCalculateBiayaKurs" id="calculatebiayakurs_showE<?= $no ?>" value="<?= number_format($countconvertion, 2, ",", "."); ?>" readonly="readonly"></td>
                  </tr>
              ...
              <br>
                ...
                <tbody id="myTablePK" >
                  ...
                  <tr>
                      ...
                      <td><input type="text" class="form-control classCalculateBiayaKursShow" id="calculatebiayakursshow<?= $no ?>" ><input type="text" class="form-control classCalculateBiayaKurs" id="calculatebiayakurs<?= $no ?>" style="width:100%;display:none"></td>
                  </tr>
                  <input style="display: none;" type="text" value="<?= $no++ ?>">
