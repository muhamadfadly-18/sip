...
<div class="page-content padding-30 container-fluid">
  ...
  <div class="page-header">
    <h1 class="page-title" style="text-transform: capitalize;">Data Pemasukan / Penerimaan Barang</h1>
    <ol class="breadcrumb">
                  ...
                  <table id="example" class="table table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($data_estimasi as $value) :
                        ...
                        $data_SUM_qty = $this->db->query("select SUM(jumlah) as total from barang_masuk_estimasi where no_transaksi = '$value->no_transaksi' ")->row();
                        $data_SUM_nilai = $this->db->query("select SUM(nilai_barang) as total from barang_masuk_estimasi where no_transaksi = '$value->no_transaksi' ")->row();
                                ...
                                <div class="btn-group" role="group">
                                  ...
                                  <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
                                    <li role="presentation">
                                      <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('PemasukanRBB/add_realisasi/' . $value->id_bm); ?>">
                  ...
                  <table id="example2" class="table table-bordered table-hover nowrap" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($data_realisasi as $value) :
                        $data_uang      = $this->db->query("select mata_uang from ref_kurs where id_kurs = '$value->id_mata_uang' ")->row();
                        $data_SUM_qty = $this->db->query("select SUM(jumlah) as total from barang_masuk_realisasi where no_transaksi = '$value->no_transaksi' ")->row();
                        $data_SUM_nilai = $this->db->query("select SUM(nilai_barang) as total from barang_masuk_realisasi where no_transaksi = '$value->no_transaksi' ")->row();
                        $data_dokumen   = $this->db->query("select dokumen from ref_dokumen where id_dokumen = '$value->jenis_doc' ")->row();
...
<script type="text/javascript">
  ...
  function subFilter2() {
    document.getElementById("IdForm2").action = "<?php echo base_url(); ?>PemasukanRBB";
