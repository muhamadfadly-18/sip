      ...
      <div class="row row-lg">
        ...
        <div class="col-md-12">
          ...
          <div class="example-wrap">
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url();?>Terminal/update/<?= $data_terminal->id_terminal;?>" method="post">

                  <div class="form-group">
                    <label class="col-sm-2 control-label" style="text-align: left; font-weight: bold;">Terminal </label>
                    <div class="col-sm-4">
                      <input type="text" autocomplete="off" placeholder="Terminal" required name="terminal" class="form-control" value="<?= $data_terminal->terminal ?>">
                    </div>
                  </div>
