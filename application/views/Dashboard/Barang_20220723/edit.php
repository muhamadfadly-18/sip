                      ...
                      <select name='jenis' id="jenis" class="form-control">
                        <option> Pilih Jenis </option>
                                    ...
                                    foreach($jenis as $value)
                                        {   ?>
                                         <option value="<?= $value->id_jenis ?>" <?php if($value->id_jenis==$data->id_jenis){ echo 'selected';} ?> ><?= $value->jenis  ?></option>
                                     <?php }
                                     ?>
                      ...
                      <select name='satuan' id="satuan" class="form-control">
                         <option> Pilih Satuan </option>
                                    ...
                                    foreach($satuan as $value)
                                        {   ?>
                                         <option value="<?= $value->uom ?>" <?php if($value->uom==$data->uom){ echo 'selected';} ?>><?= $value->uom  ?> - <?= $value->keterangan  ?></option>
                                     <?php }
                                     ?>
