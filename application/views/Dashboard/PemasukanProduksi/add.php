      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <div class="example-wrap">
            <h4 class="example-title">Tambah Data Pengeluaran Barang Untuk Blending Sederhana Baru</h4>
            <p>
            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>PemasukanProduksi/add_action" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="date" autocomplete="off" placeholder="Tanggal Produksi" required name="tanggal_production" class="form-control" value="<?= date('Y-m-d'); ?>">
                  </div>
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" autocomplete="off" placeholder="Batch" required name="batch" class="form-control">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <select id="id_po_number" name="kode_barang" class="form-control" style="width:100%;" onchange="VlidasiPo_Number()">
                      ...
                      ?>
                        <option value="<?= $value->id_barang ?>"><?php echo $value->id_barang; ?> - <?php echo $value->nama_brg; ?> - <?php echo $value->uom; ?></option>
                      <?php } ?>
                      '
                    </select>
                    </select>
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" style="width:100%;" class="form-control" id="id_no_pengeluaran" name="no_pengeluaran" readonly>
                  </div>
                  <!-- <div class="col-sm-3">
                      <input type="text" class="form-control" style="width:100%;" class="form-control" id="id_no_pengeluaran2" name="no_pengeluaran" readonly>
                    </div> -->
                </div>
                <br>
...
<script type="text/javascript">
  function addPK() {
    ...
    cell2.innerHTML = '<select class="form-control selectX classKeteranganBarang" id="KeteranganBarang" style="width:120px;">' +
    ...
    cell3.innerHTML = '<input type="text" class="form-control classTerminal" style="width:120px;" value="<?php echo $terminal2->terminal ?>" disabled="disabled">';
    cell4.innerHTML = '<select id="tank" class="form-control selectX classTank" style="width:120px;" onchange="validasi()">' +
      '<option value="">Pilih</option>' +
      <?php
      foreach ($tank2 as $value) {
      ?> '<option value="<?php echo $value->tank; ?>"><?php echo $value->tank; ?></option>' +
      <?php } ?> '</select>';
    cell5.innerHTML = '<input type="text" class="form-control classStokTank" style="width:120px;" class="form-control" id="stoktank" readonly>';
    cell6.innerHTML = '<select class="form-control selectX classTank2" id="tank2" style="width:120px;">' +
      '<option>Pilih</option>' +
      <?php
      foreach ($tank2 as $value) {
      ?> '<option value="<?php echo $value->tank; ?>"><?php echo $value->tank; ?></option>' +
    ...
    cell7.innerHTML = '<input type="text" class="form-control classQty" style="width:120px;" class="form-control" id="qty">';
