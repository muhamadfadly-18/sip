...
<div class="page-header">
  <h1 class="page-title" style="text-transform: capitalize;">Data Rekening</h1>
  <ol class="breadcrumb">
	<li><a href="<?php echo base_url();?>">Beranda</a></li>
	<li class="active">Rekening</li>
  </ol>
  <div class="page-header-actions">
	  <a href="<?php echo base_url('Rekening/add/');?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
							...
							<div class="btn-group" role="group">
								...
								<ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
								  <li role="presentation">
									  <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Rekening/edit/'.$value->no_rek);?>">
									  <i class="icon wb-edit" aria-hidden="true"></i>
									  Edit
									  </a>
								  </li>
								  <li role="presentation">
									  <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Rekening/delete/'.$value->no_rek);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
