        ...
        $sum_value = $this->db->query("select sum(jumlah) as total from barang_keluar_realisasi where no_transaksi = '$value->no_transaksi' ")->row();
          ...
          ?>
            <tr>
                ...
                <td>
                                <a style="text-decoration:none; text-align:center;" class="btn btn-block btn-primary" href="<?php echo base_url('Approve/Review_bk/'.$value->id_bk);?>" target="_blank">
                                ...
                                <a style="text-decoration:none; text-align:center;" class="btn btn-block btn-warning" href="<?php echo base_url('Approve/revisi_barang_keluar/'.$value->no_transaksi);?>">
