...
<div class="page-header">
  <h1 class="page-title" style="text-transform: capitalize;">Data Saldo Awal</h1>
  <ol class="breadcrumb">
	<li><a href="<?php echo base_url();?>">Beranda</a></li>
	<li class="active">Saldo Awal</li>
  </ol>
  <div class="page-header-actions">
	  <a href="<?php echo base_url('SaldoAwal/add/');?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
...
?>
	...
	<div class="panel panel-bordered panel-primary">
			<div class="panel-heading">
				<div class="row">
					<h3 class="panel-title">Daftar Data Saldo Awal</h3>
				</div>
			</div>
							...
							<div class="btn-group" role="group">
								...
								<ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
								  <li role="presentation">
									  <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('SaldoAwal/edit/'.$value->no_rek);?>">
									  <i class="icon wb-edit" aria-hidden="true"></i>
									  Edit
									  </a>
								  </li>
								  <li role="presentation">
									  <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('SaldoAwal/delete/'.$value->no_rek);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
