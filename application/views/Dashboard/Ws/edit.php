...
<script type="text/javascript">
  function addPK() {
    ...
    cell6.innerHTML = '<select id="tank2" class="form-control selectX classTank2" style="width:150px;" >' +
      '<option>Pilih</option>' +
      <?php
      foreach ($tank2 as $value) {
      ?> '<option value="<?php echo $value->tank; ?>"><?php echo $value->tank; ?></option>' +
    ...
    cell7.innerHTML = '<input type="text" class="form-control classQty" style="width:120px;" id="qty">';
