<div class="page-content padding-30 container-fluid">
  ...
  <div class="page-header">
    <div class="page-header-actions">
  	  <a href="<?php echo base_url('subactivity/add/');?>" class="btn btn-sm btn-default btn-block btn-primary">
...
?>
  ...
  <div class="panel panel-bordered">
    <div class="panel-heading">
      <div class="row">
        <h3 class="panel-title">Sub Activity</h3>
      </div>
    </div>
    <div class="panel-body">
      <table class="table table-hover dataTable table-striped width-full overf" data-plugin="dataTable">
        ...
        <?php
          $no=1;
          foreach ($DataSubActivity as $value):
            $v_Activity = $this->db->query("SELECT nama_activity FROM ref_activity WHERE id_activity = '$value->id_activity' ")->row();

        ?>
          <tr>
          <td><?= $no++;?></td>
          <td><?= $v_Activity->nama_activity;?></td>
          <td><?= $value->nama_subactivity;?></td>
          <td>
              <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
                  <li role="presentation">
                    <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('subactivity/edit/'.$value->id_subactivity);?>">
                    <i class="icon wb-edit" aria-hidden="true"></i>
                    Edit
                    </a>
                  </li>
                  <li role="presentation">
                    <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('subactivity/delete/'.$value->id_subactivity);?>">
