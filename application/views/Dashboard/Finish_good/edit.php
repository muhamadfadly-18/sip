      ...
      <div class="row row-lg">
        ...
        <div class="col-sm-12 col-md-12">
          ...
          <div class="example-wrap">
            <h4 class="example-title">Edit Data Data Penerimaan Barang Hasil Blending Baru</h4>
            <p>
              **Isi kolom di bawah dengan benar.
            </p>
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>Finish_good/update/<?= $data->id_finish_goods ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="date" autocomplete="off" placeholder="Tanggal Finish Goods" required name="tanggal_finish_goods" class="form-control" value="<?= $data->tanggal_finish_goods ?>">
                  </div>
                </div>
                <br>
...
<script type="text/javascript">
  function addPK() {
    ...
    cell2.innerHTML = '<select class="form-control selectX classKeteranganBarang" id="KeteranganBarang" style="width:100px;">' +
    ...
    cell4.innerHTML = '<select id="tank" class="form-control selectX classTank" style="width:100px;" onchange="validasi()">' +
      '<option>Pilih</option>' +
      <?php
      foreach ($tank2 as $value) {
      ?> '<option value="<?php echo $value->tank; ?>"><?php echo $value->tank; ?></option>' +
      <?php } ?> '</select>';
    cell5.innerHTML = '<input type="text" class="form-control  classStokTank" style="width:120px;" id="stoktank" readonly>';

    cell6.innerHTML = '<select id="tank2" class="form-control selectX classTank2" style="width:200px;">' +
      '<option>Pilih</option>' +
      <?php
      foreach ($tank2 as $value) {
      ?> '<option value="<?php echo $value->tank; ?>"><?php echo $value->tank; ?></option>' +
    ...
    cell7.innerHTML = '<input type="text" class="form-control classQty" style="width:100px;" class="form-control" id="qty">';
