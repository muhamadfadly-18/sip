...
// });
  ...
  function addPK() {
    ...
    cell5.innerHTML = '<select class="form-control selectX classCur" style="width:100%;">'+
                      ...
                      <?php } ?>
                      '</select>';
    cell6.innerHTML = '<input type="text" class="form-control classHarga" style="width:100%;" id="harga' + a + '" oninput="this.value = formatNumber(this.value)">' + '<input type="text" class="form-control classHargaUrutan" style="width:100%; display:none" id="urutan_diem" value="' + j + '">';
