<div class="page-content padding-30 container-fluid">
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('StockOpname'); ?>">Stock Opname</a></li>
            <li class="active">Create Stock Opname</li>
        </ol>
            ...
            <div class="row row-lg">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <form class="form-horizontal" action="<?php echo base_url(); ?>StockOpname/add_action" method="post">
...
<script type="text/javascript">
    function addPK() {
        ...
        function validasi() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_URL('StockOpname/Validasibarang'); ?>",
