<div class="page-content padding-30 container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">Stock Opname Barang Produksi</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>">Beranda</a></li>
            <li><a href="<?php echo base_url('OpnameBarangProduksi'); ?>">Opname Barang Produksi</a></li>
            <li class="active">Create Stock Opname Barang Produksi</li>
        </ol>
        <div class="page-header-actions">
            <a href="<?php echo base_url('OpnameBarangProduksi'); ?>" class="btn btn-sm btn-danger  btn-round">
            ...
            <div class="row row-lg">
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                            <form class="form-horizontal" action="<?php echo base_url(); ?>OpnameBarangProduksi/add_action" method="post">
...
<script type="text/javascript">
    function addPK() {
        ...
        function validasi() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_URL('OpnameBarangProduksi/Validasibarang'); ?>",
