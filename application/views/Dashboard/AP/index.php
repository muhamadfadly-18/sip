<div class="page-content padding-30 container-fluid">
	...
	<div class="page-header">
		<h1 class="page-title" style="text-transform: capitalize;">Account Payable</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url();?>">Beranda</a></li>
			<li class="active">Account Payable</li>
		</ol>
		<div class="page-header-actions">
			<a href="<?php echo base_url('AP/add/');?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
	...
	<div class="panel panel-bordered panel-primary">
	    <div class="panel-heading">
	    	<div class="row">
	    		<h3 class="panel-title">Daftar Data Account Payable</h3>
	    	</div>
	    </div>
...
<script type="text/javascript">
  ...
  function subExcel(){
	...
	function subUploadSave(){
	    document.getElementById("IdForm").action = "<?php echo base_url();?>AP/to_param_upload";
	    document.getElementById("IdForm").submit();
