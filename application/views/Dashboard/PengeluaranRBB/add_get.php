                ...
                <div class="example">
                  ...
                  <thead>
                    <tr style="text-align: center;">
                      ...
                      <td class="JudulHeadr" style="padding-left: 5px; width: 16%; border-bottom: 1px solid black;">Tank</td>
                      ...
                      <td class="JudulHeadr" style="padding-left: 5px; width: 13%; border-bottom: 1px solid black;">Harga Satuan Barang (origin price)</td>
                  ...
                  <tfoot>
                       <tr style="text-align: center;">
                        ...
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"><input type="text" id="totalshowqty" class="form-control"></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"><input type="text" id="totalshowharga" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"><input type="text" id="totalshowTH" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"><input type="text" id="totalshowBK" class="form-control" ></td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 14%;"><input type="text" id="totalshowCBK" class="form-control" ></td>
                       <!--  <td class="JudulHeadr" style="padding-left: 5px; width: 10%; border-bottom: 1px solid black;">Bulan</td>
                        <td class="JudulHeadr" style="padding-left: 5px; width: 10%; border-bottom: 1px solid black;">Tahun</td> -->
                    </tr>
                  </tfoot>
