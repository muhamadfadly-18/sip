            ...
            <div class="example">
              <form class="form-horizontal" action="<?php echo base_url(); ?>PengeluaranRBB/add_action_realisasi" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="datetime-local" autocomplete="off" placeholder="" name="pengeluaran_kargo_tgl" class="form-control box-shadow" value="<?= $data_estimasi->pengeluaran_kargo_tgl . ' ' . $data_estimasi->pengeluaran_kargo_time ?>">
                  </div>
                  <!-- <div class="col-sm-2">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="date" id="tgl_dokumen_pabean" name="tgl_dokumen_pabean" class="form-control box-shadow" placeholder="Tanggal Dokumen" value="<?= $data_estimasi->tgl_dokumen_pabean?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select data-plugin="select2" name='negara_asal' id="negara_asal" class="form-control box-shadow">
                      <option value="0">-- Pilih Negara Asal Barang --</option>
                      <?php foreach ($bendera as $value) { ?>
                        <option value="<?= $value->id_negara_asal ?>" <?= ($data_estimasi->negara_tujuan == $value->id_negara_asal) ? 'selected' : ''; ?>><?= $value->nama_negara ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
