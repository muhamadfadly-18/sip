<div class="page-content padding-30 container-fluid">
  ...
  <div class="page-header">
    <h1 class="page-title" style="text-transform: capitalize;">Data Kurs</h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url(); ?>">Beranda</a></li>
      <li class="active">Kurs</li>
    </ol>
    <div class="page-header-actions">
      <a href="<?php echo base_url('Kurs/add/'); ?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
  ...
  <div class="panel panel-bordered panel-primary">
    <div class="panel-heading">
      <div class="row">
        <h3 class="panel-title">Daftar Kurs</h3>
      </div>
    </div>
                      ...
                      <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
                              <li role="presentation">
                                <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Kurs/edit/'.$value->id_kurs);?>">
                                <i class="icon wb-edit" aria-hidden="true"></i>
                                Edit
                                </a>
                              </li>
                              <li role="presentation">
                                <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Kurs/delete/'.$value->id_kurs);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
