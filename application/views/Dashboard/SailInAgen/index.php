...
<div class="page-header">
  <h1 class="page-title" style="text-transform: capitalize;">Pengelolaan Data Sail In Agen</h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo base_url();?>">Beranda</a></li>
    <li class="active">Pengelolaan Data Sail In Agen</li>
  </ol>
  <div class="page-header-actions">
	  <a href="<?php echo base_url('SailInAgen/add/');?>" class="btn btn-sm btn-default btn-block btn-primary btn-round">
...
?>
    ...
    <div class="panel-heading">
    	<div class="row">
    		<h3 class="panel-title">Daftar Data Sail In Agen</h3>
    	</div>
    </div>
            ...
            <div class="btn-group" role="group">
                  ...
                  <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
                    <li role="presentation">
                      <a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('SailInAgen/view/'.$value->id_reg_vessel);?>">
