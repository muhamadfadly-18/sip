    ...
    <div class="panel">
      <div class="panel-body">
        ...
        <div class="form-group form-material">
          ...
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Nomor Job Order"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Tanggal Job Order :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Tanggal Job Order"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">No & Tanggal Surat Rencana Kedatangan (Sail In Plan) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="No & Tanggal Surat Rencana Kedatangan (Sail In Plan)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Nomor Form 201 & Tanggal (Sail Out) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Nomor Form 201 & Tanggal (Sail Out)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Nama Kapal (Vessel Name) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Nama Kapal (Vessel Name)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Nahkoda/Jumlah Crew :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Nahkoda/Jumlah Crew"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Gross Register Ton (GRT)/ Isi Kotor Kapal :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Gross Register Ton (GRT)/ Isi Kotor Kapal"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Lenght Over All (LOA)/ Panjang Kapal :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Lenght Over All (LOA)/ Panjang Kapal"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Actual Muatan Kapal (Cargo) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Actual Muatan Kapal (Cargo)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Jenis Cargo (Cargo Type) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Jenis Cargo (Cargo Type)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Cargo Type (Jenis Barang) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Cargo Type (Jenis Barang)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Activity (STS/WO/Bunkering/Crew/Other) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Activity (STS/WO/Bunkering/Crew/Other)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">STS Operator/Provider Name :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="STS Operator/Provider Name"\/>
        </div>
    ...
    <div class="panel">
      <div class="panel-body">
        ...
        <div class="form-group form-material">
          ...
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Name Agen Marketing"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Name Local Agen (Local Agent Name) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Name Local Agen (Local Agent Name)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Pemilik Kapal/Cargo/ Carter (ship/Cargo/Carter Owner) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Pemilik Kapal/Cargo/ Carter (ship/Cargo/Carter Owner)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Bendera Kapal (Call Sign) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Bendera Kapal (Call Sign)"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Estimate Date of Arrival :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Estimate Date of Arrival"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Estimate Time of Arrival :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Estimate Time of Arrival"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Estimate Date of Depart :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Estimate Date of Depart"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Estimate Time of Depart :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Estimate Time of Depart"\/>
        </div>
        ...
        <div class="form-group form-material">
          ...
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Voyage/Maniferst Cargo no"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Next Port :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Next Port"\/>
        </div>

        <div class="form-group form-material">
          <label class="control-label" for="inputText" style="font-weight: bold;">Last port (Tiba Dari) :</label>
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Last port (Tiba Dari)"\/>
        </div>
        ...
        <div class="form-group form-material">
          ...
          <input type="text" class="form-control" id="inputText" name="inputText" placeholder="Indiactive Fixed Rate For Sail In USD Rate Sails In Plan Date"\/>
        </div>
      ...
      <div class="panel-body">
        ...
        <table border="1" width="100%" style="border-collapse: collapse;">
          ...
          <tr>
            ...
            <th style="padding-left: 4px;">< 6,000 GT</th>
