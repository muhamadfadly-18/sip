	            	...
	            	<table class="table table-hover dataTable table-striped width-full overf" data-plugin="dataTable">
				        <thead>
				          <tr>
							...
							<th>Kode</th>
							<th>Nama Barang</th>
							<th>Spesifikasi/Model/Colour</th>
							<th>kategori</th>
							<th>Satuan</th>
							<th>Saldo</th>
							<th>keterangan</th>
				        ...
				        <?php
				        	...
				        	foreach ($data as $value):
				        		...
				        		$nama_stn =$this->db->query("SELECT keterangan FROM ref_satuan where id_unit = '$value->id_unit' ")->row();
				        ?>
				          <tr>
										<td><?= $no++;?></td>
				            	...
				            	<div class="btn-group" role="group">
				                    ...
				                    <ul class="dropdown-menu" style="min-width:10px;" aria-labelledby="exampleIconDropdown1" role="menu">
				                      <li role="presentation">
				                      	<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Barang/edit/'.$value->id_barang);?>">
				                      	<i class="icon wb-edit" aria-hidden="true"></i>
				                      	Edit
				                      	</a>
				                      </li>
				                      <li role="presentation">
				                      	<a style="text-decoration:none; text-align:left;" class="btn btn-block btn-default" href="<?php echo base_url('Barang/delete/'.$value->id_barang);?>" onclick="return confirm('Apakah Anda yakin akan menghapus data ini ?')">
